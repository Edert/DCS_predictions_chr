...
#cat ../18_simulating_add_chrom-frips/data/mm10*fasta |  sed "s/mm_//"  > /tmp/mm10_subset.fasta
#epic-effective --read-length=50 --nb-cpu=15 /tmp/mm10_subset.fasta
#Genome length:  679418592
#Number unique 50-mers: 589334485 (File: effective_genome_size, Log level: INFO, Time: Mon, 22 Nov 2021 09:04:56 )
#Effective genome size: 0.867410006054 (File: effective_genome_size, Log level: INFO, Time: Mon, 22 Nov 2021 09:04:56 )
#Number unique 50-mers:  589334485
#Effective genome size:  0.867410006054
...
if [ "$files" = "0" ]; then
  ...
  sicer -t S11.bed -c IN1.bed -s mm10 -rt 1 -w $WINDOW -f 200 -egf $EGF -fdr 0.01 -g $GAP -cpu 1 >> $LOG 2>&1
  ...
  sicer -t S12.bed -c IN1.bed -s mm10 -rt 1 -w $WINDOW -f 200 -egf $EGF -fdr 0.01 -g $GAP  -cpu 1 >> $LOG 2>&1
  ...
  sicer -t S21.bed -c IN2.bed -s mm10 -rt 1 -w $WINDOW -f 200 -egf $EGF -fdr 0.01 -g $GAP  -cpu 1 >> $LOG 2>&1
  ...
  sicer -t S22.bed -c IN2.bed -s mm10 -rt 1 -w $WINDOW -f 200 -egf $EGF -fdr 0.01 -g $GAP  -cpu 1 >> $LOG 2>&1
